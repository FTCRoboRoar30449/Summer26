...
public class Red {
    ...
    public static final Pose SCORE_POSE_AUTO = new Pose(84, 15.8, Math.toRadians(65));

    public static final Pose SCORE_POSE_NEAR = new Pose(84.7, 80.5, Math.toRadians(44));
    ...
    public static final Pose READY_FAR_POSE = new Pose(96.5,36, Math.toRadians(180));
    ...
    public static final Pose READY_MID_POSE = new Pose(96.5,60, Math.toRadians(180));
    ...
    public static final Pose READY_NEAR_POSE = new Pose(96.5,85, Math.toRadians(180));
    public static final Pose ALIGN_NEAR_POSE = new Pose(101.5, 85, Math.toRadians(180));
    public static final Pose PICKUP_NEAR_POSE = new Pose(119.5, 85, Math.toRadians(180));
    ...
    public static final Pose GATE_END_POSE = new Pose(126, 70, Math.toRadians(0));

    // Human State Pose
    public static final Pose HUMAN_STATE_POSE = new Pose(19, 13.8, Math.toRadians(0));
